...
DECLARE_IO(IO_Reserved_P2_4,     _IO(P2.4), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P2_5,     _IO(P2.5), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P2_6,     _IO(P2.6), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P2_7,     _IO(P2.7), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")

DECLARE_IO(IO_Reserved_P3_0,     _IO(P3.0), IO_MODE_ANALOG,     HIGH,  "C2DAT")
DECLARE_IO(IO_Reserved_P3_1,     _IO(P3.1), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_2,     _IO(P3.2), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_3,     _IO(P3.3), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_4,     _IO(P3.4), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_5,     _IO(P3.5), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_6,     _IO(P3.6), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
DECLARE_IO(IO_Reserved_P3_7,     _IO(P3.7), IO_MODE_DIGITAL_OD, HIGH,  "Non-existed pin")
