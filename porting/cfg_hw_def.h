...
DECLARE_IO(IO_MDIOM_SDA_IN,     _IO(P0.0), IO_MODE_DIGITAL_OD, HIGH,  "TDI_IN")
DECLARE_IO(PWM_VBUF_OUT,        _IO(P0.1), IO_MODE_DIGITAL_PP, HIGH,  "PWM_OUT")
DECLARE_IO(IO_I2CM_SCL,         _IO(P0.2), IO_MODE_DIGITAL_OD, HIGH,  "OE_TDO")
DECLARE_IO(IO_MDIOM_SCL_OEn,    _IO(P0.3), IO_MODE_DIGITAL_PP, HIGH,  "OE_TCK")
...
DECLARE_IO(IO_MDIOM_SDA_LOW,    _IO(P1.0), IO_MODE_DIGITAL_OD, LOW,   "for sample MDIOM_SDA voltage usage")
DECLARE_IO(IO_VBUF_OEn,         _IO(P1.1), IO_MODE_DIGITAL_OD, HIGH,  "TDO_IN")
DECLARE_IO(IO_I2CM_SDA,         _IO(P1.2), IO_MODE_DIGITAL_OD, HIGH,  "TDO_OUT")
DECLARE_IO(IO_LED_1_OUT,        _IO(P1.3), IO_MODE_DIGITAL_PP, LOW,   "LED_1")
DECLARE_IO(IO_MDIOM_SDA_OUT,    _IO(P1.4), IO_MODE_DIGITAL_PP, HIGH,  "TDI_OUT")
DECLARE_IO(IO_MDIOM_SCL_IN,     _IO(P1.5), IO_MODE_DIGITAL_OD, HIGH,  "TCK_IN")
DECLARE_IO(IO_MDIOM_SCL_OUT,    _IO(P1.6), IO_MODE_DIGITAL_PP, HIGH,  "TCK_OUT")
DECLARE_IO(IO_C2M_SCL,          _IO(P1.7), IO_MODE_DIGITAL_OD, HIGH,  "TMS_IN")

DECLARE_IO(IO_C2M_SDA,          _IO(P2.0), IO_MODE_DIGITAL_OD, HIGH,  "TMD_OUT")
DECLARE_IO(IO_MDIOM_SDA_OEn,    _IO(P2.1), IO_MODE_DIGITAL_PP, HIGH,  "OE_TDI")
...
DECLARE_IO(ADC_MDIOM_SDA_IN,    _IO(P3.0), IO_MODE_ANALOG,     HIGH,  "C2DAT")
